         ...
         <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
               ...
               <p className="text-slate-400 text-sm max-w-xl font-medium ml-1">
                  Developer guide for maintaining, debugging, and extending SAFETEQ.
               </p>
            </div>
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              <div className="p-5 border border-slate-200 dark:border-slate-700 rounded-xl">
                                  ...
                                  <ul className="text-xs text-slate-600 dark:text-slate-400 space-y-2 list-disc pl-4">
                                      <li>
                                          <strong>Inactive Logic:</strong> If an employee is removed from Source A, the Middleware marks them as <code>isActive: false</code> in SAFETEQ. It does <em>not</em> delete the record to preserve audit history.
                                      </li>
                                      <li>
